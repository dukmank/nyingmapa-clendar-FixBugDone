...
class AddPracticeScreen extends ConsumerStatefulWidget {
  const AddPracticeScreen({super.key});

  @override
  ConsumerState<AddPracticeScreen> createState() => _AddPracticeScreenState();
}

class _AddPracticeScreenState extends ConsumerState<AddPracticeScreen> {
  final titleCtrl = TextEditingController();
  final contentCtrl = TextEditingController();

  Color selectedColor = AppColors.maroon;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _input("Title", "Enter practice name", titleCtrl),
                    const SizedBox(height: 16),

                    _input("Content", "Enter practice description", contentCtrl, maxLines: 4),
                ...
                child: DecoratedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      await LocalDataService.createUserPractice(practice);

                      if (mounted) Navigator.pop(context, practice);
                    },
                    child: const Text(
                      "Add",
                      style: TextStyle(
